...
function bot_ui_ini() {
  ...
  botui.message
    .add({ delay: 800, content: "Hi, 欢迎来到我的博客👋" })
    .then(function () {
      botui.message
        .add({ delay: 1100, content: "这里是 差点是个胖子" })
        .then(function () {
          botui.message
            .add({ delay: 1100, content: "我还不是个胖子~" })
            .then(function () {
              botui.action
                .button({
                  delay: 1600,
  ...
  var sure = function () {
    ...
    secondpart = function () {
      botui.message
        .add({ delay: 1500, content: "毕业与成都西华大学" })
        .then(function () {
          botui.message
            .add({ delay: 1500, content: "材料科学与工程专业" })
            .then(function () {
              botui.message
                .add({ delay: 1200, content: "目前就职于不知名互联网企业" })
                .then(function () {
                  botui.message
                    .add({
                      delay: 1500,
                      content: "是一个技能点乱七八糟的产品经理",
                    })
                    .then(function () {
                      botui.message
                        .add({
                          delay: 1800,
                          content: "喜欢折腾这些奇奇怪怪的技术～",
                        })
                        .then(function () {
                          botui.action
                            .button({
    ...
    thirdpart = function () {
      botui.message.add({
        delay: 1e3,
        content: "工作几年了，一个成熟的社畜已经知道要开始总结沉淀一下自己了。",
      });
    };
}
